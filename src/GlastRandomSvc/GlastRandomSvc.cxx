...
{
  // Purpose and Method: Looks for tools that inherit from the RandomAccess
  //                     class. For those it finds, it sets the CLHEP engine
  //                     type via the job options parameter RandomEngine,
  //                     the default value for which can be found in the 
  //                     GlastRandomSvc constructor. Finally it gets the
  //                     address of the CLHEP engine and puts it in a map
  //                     along with the name of the tool.
  //                     
  // Inputs: None        
  // Outputs: None
  // Dependencies: None
...
void GlastRandomSvc::handle(const Incident &inc)
{
  ...
  // Purpose and Method: Sets seeds for the CLHEP random engines obtained
  //                     in GlastRandomSvc::initialize(), and based on 
  //                     run and particle sequence number from MCEvent.  
  //                     It use the Gaudi incident service to trigger on 
  //                     "BeginEvent" events, i.e. it sets the seeds at
  //                     the beggining of the event loop.
  //  
  //                     
  // Inputs:  address of incidnet
  // Outputs: None
  // Dependencies: None
  // Restrictions and Caveats:  None
